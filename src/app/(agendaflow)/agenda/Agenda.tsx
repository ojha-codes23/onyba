                        ...
                        {agendaData.events.filter(ev => {
                            ...
                            <div key={event.id} className={`agd-event-card ${event.colorClass}`} style={{top: event.top, height: "fitContent"}}>
                                <div className="agd-ev-header">
                                    <span className="agd-ev-time"><img src="/images/agenda-clock-icon.svg" alt=""/> {event.time}</span><button className="right-agenda-icon"><img src="/images/right-agenda-icon.svg" alt=""/></button>
                                </div>
