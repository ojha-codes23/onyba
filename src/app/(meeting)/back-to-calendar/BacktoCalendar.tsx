        ...
        <div className="ps-dash-editor-wrapper">
          ...
          <div className="ps-dash-toolbar">
            <div className="ps-dash-toolbar-left">
              ...
              <svg className="ps-dash-tool-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style={{cursor: 'pointer'}} onMouseDown={(e) => { e.preventDefault(); execCommand('justifyLeft'); }}><path d="M4 6h16M4 12h10M4 18h16"/></svg>
              <svg className="ps-dash-tool-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style={{cursor: 'pointer'}} onMouseDown={(e) => { e.preventDefault(); execCommand('justifyCenter'); }}><path d="M4 6h16M4 12h16M4 18h16"/></svg>
            </div>
            <svg className="ps-dash-tool-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style={{cursor: 'pointer'}} onMouseDown={(e) => { e.preventDefault(); execCommand('insertUnorderedList'); }}><path d="M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7"/></svg>
          </div>
